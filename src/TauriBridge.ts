...
const electronAPI: any = {
  ...
  localSearchFiles: (rootPath: string, query: string, maxResults?: number) => invoke('local_search_files', { rootPath, query, maxResults }),
  ...
  localRenameNode: (oldPath: string, newPath: string) => invoke('local_rename_node', { oldPath, newPath }),
  ...
  sftpUpload: (id: string, localPath: string, remotePath: string, jid: string, options?: any) => invoke('sftp_upload', { id, localPath, remotePath, jid, options: options || null }),
  sftpDownload: (id: string, remotePath: string, localPath: string, jid: string, options?: any) => invoke('sftp_download', { id, remotePath, localPath, jid, options: options || null }),
